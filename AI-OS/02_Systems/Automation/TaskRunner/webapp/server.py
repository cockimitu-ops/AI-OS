...
API_ROUTES = {
    ...
    ("GET", "/api/engines"): api.get_engines,
    ("POST", "/api/engine-send"): api.post_engine_send,
    ("POST", "/api/engine-result"): api.post_engine_result,
    ("POST", "/api/background-task"): api.post_background_task,
    ("GET", "/api/notifications"): api.get_notifications,
    ("POST", "/api/notification-read"): api.post_notification_read,
    ("POST", "/api/knowledge-save"): api.post_knowledge_save,
    ...
    ("POST", "/api/consensus-start"): api.post_consensus_start,
    ("POST", "/api/consensus-result"): api.get_consensus_result,
    ("POST", "/api/checkpoint-create"): api.post_checkpoint_create,
    ("POST", "/api/checkpoint-restore"): api.post_checkpoint_restore,
    ("GET", "/api/checkpoints"): api.get_checkpoints,
    ("POST", "/api/proposals-batch"): api.post_proposals_batch,
