...
- [[10_Projects/TemplateSales/README|TemplateSales]] — **Micro-SaaS Moat Blueprint live** (2026-08-27), waiting on the first sale. Reddit distribution blocked on a 3-5 day r/SaaS comment-history warm-up (no shortcut — the sub actively removes zero-participation posters). Pricing Teardown and Retention Engineering built, unpublished, staged per `_infra/LAUNCH-ORDER.md`.
...
- ~~Publish Micro-SaaS Moat Blueprint~~ — **live 2026-08-27.** Waiting on the first sale. Pricing Teardown and Retention Engineering still need publishing, per `_infra/LAUNCH-ORDER.md`'s spacing.
...
- Choose a new story topic, and settle AI Video Production's status — **both deliberately deferred** until the remaining two TemplateSales products (Pricing Teardown, Retention Engineering) are published. Not blocking anything.
